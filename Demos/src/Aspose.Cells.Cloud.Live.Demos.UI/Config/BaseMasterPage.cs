...
namespace Aspose.Cells.Cloud.Live.Demos.UI.Config
{
    ...
    {
        private AsposeCellsCloudContext _atContext;
        ...
        public AsposeCellsCloudContext AsposeCellsCloudContext
		{
            get
            {
                if (_atContext == null) _atContext = new AsposeCellsCloudContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		protected override void OnLoad(EventArgs e)
        {
			...
			AsposeCellsCloudContext.atcc = AsposeCellsCloudContext;
            base.OnLoad(e);
        }
    }
}

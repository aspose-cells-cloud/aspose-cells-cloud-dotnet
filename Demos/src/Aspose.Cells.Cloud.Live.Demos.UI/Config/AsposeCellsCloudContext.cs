...
{
	/// <summary>
	/// Wrapper class for Aspose.Cells Cloud Tools context access to Pages and controls
	/// </summary>
	public class AsposeCellsCloudContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeCellsCloudContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeCellsCloudContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeCellsCloudContext atcc { set { atc = value; } }
		internal static AsposeCellsCloudContext Current
		{
			get { return atc; }
		}
